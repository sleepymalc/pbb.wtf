...
This is a quite and fun project to work on; while the proof idea is elementary, the result is intuitive and elegant. If you're interested, please see the [Paper](./paper.pdf) and the [Poster](./poster.pdf)!