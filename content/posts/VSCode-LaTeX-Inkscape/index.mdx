...
Note that I set the `"conceal.revealOn"` to `"active-line"`, which is why you will see the source code in line 58. There are other options you can choose, see the original repo for details. 
