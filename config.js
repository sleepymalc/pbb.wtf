module.exports = {
  ...
  introduction: [
    ...
    'Despite my current research topic, my interest spreads widely among topics in theoretical computer science and both pure and applied mathematics. In theoretical computer science, I\'m interested in approximation algorithm, randomized algorithm, online algorithm, and graph algorithm specifically. In applied math, I\'m amazed by topics across applied linear algebra, random matrix theory, sensitivity analysis and statistic. As for pure math, I recently fell in love with differential and algebraic topology, functional analysis, and also category theory. Some of my courses notes are available [here](./posts/Notes), go check it out!',
    'Other than academic interests, I also have a lot of hobbies. I love street photography in particular, check out my personal [account](https://www.instagram.com/malc_ph/) 📷! I also love playing drums 🥁, and I\'m currently learning guitar 🎸.',
  ],
  avatar: 'avatar.png',
  professions: [
    'Mathematician',
