module.exports = {
  ...
  introduction: [
    ...
    `I do *AI* and *TCS* with **math** on **graphs**. In general, I try to *theoretically* understand algorithms by proving its, e.g., *robustness*, *fairness*. I'm currently focusing on *unlearning problems* and *sparse graph limits*.`,
    `I think about many problems, while some of them haunt me more than others. For example, *what is the analogy of **computational complexity theory** for modern (deep) learning problems?* In other words, how much can we say about the *hardness* of deep learning problems?`,
