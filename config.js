module.exports = {
  ...
  introduction: [
    ...
    `* 🧑🏻‍🏫 I taught [*Introduction to Cryptography*](https://mahdi.ch/eecs475/) (undergraduate-level) during the Winter 2023 semester (*Jan. 4, 2023*). [➡️](./experience/)`,
    ...
    `* 🧑🏻‍🏫 I taught [*Honor Mathematics III*](https://umji.sjtu.edu.cn/~horst/teaching/vv285.html) (undergraduate-level) during the Summer 2021 semester (*May 1, 2021*). [➡️](./experience/)`,
    `* 🧑🏻‍🏫 I taught [*Honor Mathematics II*](https://umji.sjtu.edu.cn/~horst/teaching/vv186.html) (undergraduate-level) during the Fall 2020 semester (*Sep. 7, 2020*). [➡️](./experience/)`,
    `</details>`,
    `### 🔖 Misc`,
