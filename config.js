module.exports = {
  ...
  introduction: [
    ...
    'My interest spreads widely among TCS and math. To name a few: I *algorithm design*, *computational complexity* 🧠, *high dimensional statistic* 📊, *analysis*, *geometry/topology* and *optimization theory* 📚. Occasionally, I\'ll do [street photography](https://street.pbb.wtf/) 📷 and write [blog posts](./posts) 📝.', ,
