module.exports = {
  ...
  introduction: [
    ...
    `I think about many problems, while a particular one of them haunts me more than others: *What is the analogy of **computational complexity theory** for modern (deep) learning problems?* In other words, how much can we say about the *hardness* of deep learning problems?`,
