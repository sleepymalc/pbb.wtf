module.exports = {
	...
	introduction: [
		...
		'### 🗞️ News',
		'- 🚀 <pre>[Jun 2026]</pre> Incoming intern @[*SIG*](https://sig.com/) Deep Learning team, come hanging out in Philly 🦅!',
		'- 👨‍🎓 <pre>[Nov 2025]</pre> Incoming fellow @[*Anthropic*](https://www.anthropic.com/) Alignment Science team, come hanging out in San Francisco 🌉!',
		'- 📚 <pre>[Oct 2025]</pre> We are organizing the *Symposium on Information Retrieval and Language Models* at UIUC!',
		'- 🎙️ <pre>[Oct 2025]</pre> Giving a [tutorial](https://trais-lab.github.io/dattri-reading-group/recording/2025/13/) on recent tricks in computing gradient-based data attribution, including [GraSS](./research/GraSS/)!',
		'- 🍻 <pre>[Sep 2025]</pre> Please check out our new [survey paper 📝 on data attribution](./research/Data-Attribution-Survey/)!',
		'- 🍻 <pre>[Sep 2025]</pre> Two papers 📝 accepted by *NeurIPS 2025* with one first-authored and one co-first-authored!',
		'- 🎓 <pre>[Aug 2025]</pre> Get my M.S. Applied Math Degree at UIUC!',
		'- 📚 <pre>[Jul 2025]</pre> We are organizing the [3rd Workshop on Regulatable Machine Learning](https://regulatableml.github.io/) in conjunction with *NeurIPS 2025*!',
		'- 🎙️ <pre>[Jul 2025]</pre> Giving a talk on [Data Attribution](./else/Intro-to-DA.pdf) at the [*Guided Generation Group (GGG)*](https://github.com/GuidedGenerationGroup)!',
		'- 🤖 <pre>[Jun 2025]</pre> Attending the first [AI Startup School](https://events.ycombinator.com/ai-sus) held by [*Y Combinator*](https://www.ycombinator.com/), see you in San Francisco 🌉!',
		'- 🚀 <pre>[Mar 2025]</pre> Interning @[*Amazon AWS AI*](https://aws.amazon.com/ai/) Deep Engine Science team, come hanging out in New York 🗽!',
		'- 🍻 <pre>[Jan 2025]</pre> One paper 📝 accepted by *ICLR 2025*.',
		'- 🏆 <pre>[Nov 2024]</pre> Received the **Graduate Conference Travel Award** from UIUC!',
		'- 🏆 <pre>[Oct 2024]</pre> Received the **NeurIPS 2024 Scholar Award**, see you in Vancouver!',
		'- 🍻 <pre>[Sep 2024]</pre> Two papers 📝 accepted by *NeurIPS 2024* with one ***Spotlight***.',
		'- 📚 <pre>[Jun 2024]</pre> We launched the ongoing [*Data Attribution Reading Group*](https://trais-lab.github.io/dattri-reading-group/).',
		'- 🚀 <pre>[May 2024]</pre> Interning @[*National Institute of Informatics*](https://www.nii.ac.jp/en/), come hanging out in Tokyo 🇯🇵!',
		// '* 📚 I initiated the *Statistical Learning Theory* Reading Group (*Jan. 2024*).',
		'',
		'### 🔖 Misc',
