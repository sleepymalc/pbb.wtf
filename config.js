module.exports = {
  ...
  introduction: [
    'I\'m a first year Ph.D. student at *University of Illinois Urbana-Champaign* 🌽 advised by [Jiaqi Ma](https://www.jiaqima.com/), holding a [dual Bachelor degree](https://www.ji.sjtu.edu.cn/academics/ipo/study-abroad/degree-programs/) from *University of Michigan* 〽️ and *Shanghai Jiao Tong University* 🇨🇳. *I do **AI** and **TCS** with **math** on **graphs***.',
    `In general, I try to design and understand algorithms by proving its *robustness*, *fairness*, etc. I\'m interested in the *hardness* of deep learning problems, although currently this is not my focus. When I\'m not thinking about all the above, I\'ll do [*photography*](https://street.pbb.wtf/) 📷, write [*random posts*](./posts) 📝, and stay up late 🌌.`,
