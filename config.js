module.exports = {
  ...
  introduction: [
    ...
    `Specifically, I enjoy thinking about *graph neural networks* 🤖, *algorithmic complexity* 🧠, and *high dimensional statistic* 📊. I also do [*photography*](https://street.pbb.wtf/) 📷 and write [*blog posts*](./posts) 📝. ***Now***, I\'m: designing *fast graph algorithms*, exploring *machine unlearning*, and studying *graphings* (and learning guitar 🎸).`,
  ],
  avatar: 'avatar.png',
  professions: [
    'I speak TeX.'
