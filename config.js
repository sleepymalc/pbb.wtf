module.exports = {
  ...
  introduction: [
    ...
    `In my spare time, I do [*street photography*](https://street.pbb.wtf/) 📷 and are constantly writing [*course notes*](./posts/Notes) 📝. I also enjoy reading abstract nonsense (i.e., research-unrelated math) just to keep my brain fresh.`,
