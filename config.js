module.exports = {
  ...
  introduction: [
    ...
    'I obtained my ([dual-degree program](https://www.ji.sjtu.edu.cn/academics/ipo/study-abroad/degree-programs/)) B.S. degree in **Computer Science** (minor in **Mathematics**) at *University of Michigan (UMich)* 🇺🇸 and B.E. degree in **Electrical Computer Engineering** at *Shanghai Jiao Tong University (SJTU)* 🇨🇳.',
