module.exports = {
	...
	introduction: [
		'I\'m a second-year Ph.D. candidate at [*University of Illinois Urbana-Champaign*](https://illinois.edu/) 🌽 advised by [Jiaqi Ma](https://jiaqima.github.io/). During my PhD, I\'ve had the immense delight of interning at [*National Institute of Informatics*](https://www.nii.ac.jp/en/) 🇯🇵 and [*Amazon AWS AI Lab*](https://aws.amazon.com/ai/) 🗽. Previously, I obtained my Ms. Math degree from [*University of Illinois Urbana-Champaign*](https://illinois.edu/) and [dual Bachelor degree](https://www.ji.sjtu.edu.cn/academics/ipo/study-abroad/degree-programs/) from [*University of Michigan*](https://umich.edu/) 〽️ and [*Shanghai Jiao Tong University*](https://www.sjtu.edu.cn/) 🇨🇳.',
