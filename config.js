module.exports = {
  ...
  introduction: [
    ...
    `* 🔔 *May 12, 2024*: I\'m visiting the [National Institute of Informatics](https://www.nii.ac.jp/en/) 🇯🇵 as a summer research intern.`,
    ...
    `* 📚 *May 1, 2023*: I led a *Large Graph Limit* Reading Group, which has now concluded.`,
    `* 🧑🏻‍🏫 *Jan. 1, 2023*: I taught [EECS475 Introduction to Cryptography](https://mahdi.ch/eecs475/) (Undergrad) during the Winter 2023 semester.`,
    `* 🧑🏻‍🏫 *Sep. 1, 2022*: I taught [EECS572 Randomness and Computation](https://mahdi.ch/eecs572/) (Graduate) during the Fall 2022 semester.`,
    `* 🧑🏻‍🏫 *May 1, 2021*: I taught [VV285 Honor Mathematics III](https://umji.sjtu.edu.cn/~horst/teaching/vv285.html) (Undergraduate) during the Summer 2021 semester.`,
    `* 🧑🏻‍🏫 *Sep. 1, 2020*: I taught [VV186 Honor Mathematics II](https://umji.sjtu.edu.cn/~horst/teaching/vv186.html) (Undergraduate) during the Fall 2020 semester.`,
    `</details>`,
    `### 🔖 Misc`,
