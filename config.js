module.exports = {
	...
	introduction: [
		...
		'### 🗞️ News',
		'* 🎉 One [preprint](https://arxiv.org/abs/2410.00718) 📜 on the [*Information Geometry*](./research/Pseudo-Non-Linear-Data-Augmentation-via-Energy-Minimization/) released (*Oct. 1, 2024*).',
		...
		'* 🎉 One [preprint](https://arxiv.org/abs/2409.05657) 📜 on the [*Adversarial Attack on Data Attribution* Project](./research/Adversarial-Attack-on-Data-Attribution/) released (*Sep. 9, 2024*).',
		...
		'* 🎉 One [preprint](https://arxiv.org/abs/2404.11577) 📜 on the [*Machine Unlearning Evaluation* Project](./research/Unlearning-Sample-Inference-Game/) released (*Apr. 17, 2024*).',
			...
			data: [
				{
					...
					location: 'Virtual',
					description:
						'IEEE BigData *2023*, ICML *2024*, ICLR *2025*, AAAI *2025*',
				},
			],
		},
		{
