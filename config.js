module.exports = {
  ...
  introduction: [
    ...
    `*I do **Trustworthy Machine Learning Theory** with **math** on **graphs** (sometimes)*. In particular, I enjoy designing *fast*, *robust*, and *fair* algorithms, and developing their theories. I moved my focus slightly away from **TCS**, specifically, fast graph algorithms recently. But still happy to work on those! In my spare time, I do [*street photography*](https://street.pbb.wtf/) 📷 and I'm constantly writing [*course notes*](./posts/Notes) 📝.`,
