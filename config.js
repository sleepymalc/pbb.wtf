module.exports = {
  ...
  introduction: [
    'Hi there 👋! I\'m **Pingbang Hu 胡平邦** (*Hu, Pingˊ-Bongˉ*) from Taiwan 🇹🇼, an incoming Ph.D. student in **Information Science** at *University of Illinois Urbana-Champaign (UIUC)* 🇺🇸 advised by Prof. [Jiaqi Ma](https://www.jiaqima.com/). My research interest is about *machine learning theory* and also *theoretical computer science*, specialized in *graph theory* in particular.',
    'Currently, I\'m a senior student major in **Computer Science** (minor in **Mathematics**) at *University of Michigan (UMich)* 🇺🇸 and **Electrical Computer Engineering** at *Shanghai Jiao Tong University (SJTU)* 🇨🇳.',
    'Despite my research, my interest spreads widely among topics in TCS and math. To name a few: I enjoy designing/learning *approximation*, *online* and *randomized algorithm*, *computational complexity* 🧠, *high dimensional statistic* 📊, *analysis*, *geometry* and *optimization theory* 📚. Occasionally, I\'ll do [street photography](https://street.pbb.wtf/) 📷 and write [blog posts](./posts) 📝.', ,
