module.exports = {
	...
	introduction: [
		...
		'*I do **machine learning theory** with **math** on **graphs** (sometimes)*, with the goal being to draw theoretical insights from practical problems and develop algorithms with provable guarantees and desirable properties (e.g., *efficiency*, *robustness*, and *fairness*).',
		'\>I also hold a strong interest in **Theoretical Computer Science**, especially (fast) graph algorithms.',
		'### 🗞️ News',
