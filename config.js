module.exports = {
  ...
  introduction: [
    ...
    'Despite my current research topic, my interest spreads widely among topics in theoretical computer science and both abstract and applied mathematics. In theoretical computer science, I\'m interested in approximation algorithm, randomized algorithm, online algorithm, and graph algorithm specifically. In applied math, I\'m amazed by topics across applied linear algebra, random matrix theory, sensitivity analysis and statistic. As for abstract math, I recently fell in love with differential and algebraic topology, functional analysis, and also category theory. Some of my courses notes are available [here](./posts/Notes), go check it out!',
