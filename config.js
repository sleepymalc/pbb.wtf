module.exports = {
  ...
  introduction: [
    'Hi 👋! I\'m **Pingbang Hu 胡平邦** (*Hu, Pingˊ-Bongˉ*) from Taiwan 🇹🇼, an incoming Ph.D.student in **Information Science** at *University of Illinois Urbana - Champaign (UIUC)* 🇺🇸 advised by Prof. [Jiaqi Ma](https://www.jiaqima.com/). Previously, I obtained my [dual Bachelor degree](https://www.ji.sjtu.edu.cn/academics/ipo/study-abroad/degree-programs/) in **Computer Science** (minor in **Mathematics**) at *University of Michigan (UMich)* 🇺🇸 and in **Electrical Computer Engineering** at *Shanghai Jiao Tong University (SJTU)* 🇨🇳. Occasionally, I\'ll do [street photography](https://street.pbb.wtf/) 📷 and write [blog posts](./posts) 📝 besides doing research',
    'My research interest is about *machine learning theory* and *theoretical computer science*, specialized on *graphs*. To name a few: I enjoy *algorithm design*, *computational complexity* 🧠, *high dimensional statistic* 📊, *analysis*, *geometry/topology* and *optimization theory* 📚.',
