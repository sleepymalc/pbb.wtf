module.exports = {
  ...
  introduction: [
    ...
    `*I do **ML** and **TCS** with **math** on **graphs***. In general, I design *fast*, *robust*, and *fair* algorithms, develop theories, define new problems, and eventually apply them to make a social impact.`,
    `In my spare time, I do [*street photography*](https://street.pbb.wtf/) 📷 and are constantly writing [*course notes*](./posts/Notes) 📝.`,
    `🔔 **I'm currently looking for 2024 Summer internships in theoretical AI!**`,
  ],
  education: [
    {
