module.exports = {
	...
	introduction: [
		...
		'I\'m broadly interested in **trustworthy ML** and **data-centric AI**, with the goal being to draw theoretical insights from practical problems and develop algorithms with provable guarantees and desirable properties such as *efficiency*, *robustness*, and *fairness*.',
		'>I also hold a strong interest in **Theoretical Computer Science**. Previously I have worked on graph neural networks and fast graph algorithm as well.',
		'### 🗞️ News',
