module.exports = {
	...
	introduction: [
		...
		'*I\'m broadly interested in **trustworthy ML** and **data-centric AI**, with the goal being to draw theoretical insights from practical problems and develop algorithms with provable guarantees and desirable properties (e.g., *efficiency*, *robustness*, and *fairness*). I also hold a strong interest in **Theoretical Computer Science**.',
		'### 🗞️ News',
