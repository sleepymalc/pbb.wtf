module.exports = {
  ...
  introduction: [
    ...
    'Other than academic interests, I also have a lot of hobbies. I love street photography in particular, check out my personal [account](https://www.instagram.com/malc_ph/)! I also love playing drums, and I\'m currently learning how to play the guitar. But I need to admit my music flavor is a little bit extreme, I\'m really into **Metal**, especially those heavy ones.',
    'I\'m from Taiwan, and my Chinese name is **胡平邦** (pronounced as *Ping-Bang Hu*), and since I know my name is hard to pronounce in particular, so I\'ll respond to both **Benson** or **Pingbang**, just choose one you like 👀',
  ],
  avatar: 'avatar.png',
  professions: [
    'Mathematician',
