module.exports = {
	...
	introduction: [
		...
		'* 🎙️ Please check out my [tutorial](https://www.youtube.com/watch?v=LgTFvJTTau4) on recent advances in computational tricks for gradient-based data attribution at the [*Data Attribution Reading Group*](https://trais-lab.github.io/dattri-reading-group/), including my new work [GraSS](./research/GraSS/) (*Oct. 2025*)!',
		'* 📝 Please check out our new [survey paper on data attribution](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5451054) (*Sep. 2025*)!',
		...
		'* 📚 We are organizing the [3rd Workshop on Regulatable Machine Learning](https://regulatableml.github.io/) in conjunction with *NeurIPS 2025* (*Jul. 2025*)!',
		'* 🎙️ Giving a talk on [Data Attribution](./else/Intro-to-DA.pdf) at the [*Guided Generation Group (GGG)*](https://github.com/GuidedGenerationGroup) (*Jul. 2025*)!',
		'* 🤖 Attending the first [AI Startup School](https://events.ycombinator.com/ai-sus) held by [*Y Combinator*](https://www.ycombinator.com/), see you in San Francisco 🌉 (*Jun. 2025*)!',
		'* 🚀 Interning @[*Amazon AWS AI*](https://aws.amazon.com/ai/) Deep Engine Science team, come hanging out in New York 🗽 (*Mar. 2025*)!',
		'* 🍻 One paper 📝 accepted by *ICLR 2025* (*Jan. 2025*).',
		'* 🏆 Received the **Graduate Conference Travel Award** from UIUC (*Nov. 2024*)!',
		'* 🏆 Received the **NeurIPS 2024 Scholar Award**, see you in Vancouver (*Oct. 2024*)!',
		'* 🍻 Two papers 📝 accepted by *NeurIPS 2024* with one ***Spotlight*** (*Sep. 2024*).',
		'* 📚 We launched the ongoing [*Data Attribution Reading Group*](https://trais-lab.github.io/dattri-reading-group/) (*June 2024*).',
		'* 🚀 Interning @[*National Institute of Informatics*](https://www.nii.ac.jp/en/), come hanging out in Tokyo 🇯🇵 (*May 2024*)!',
