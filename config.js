module.exports = {
  ...
  introduction: [
    ...
    `I do *AI* and *TCS* with **math** on **graphs**. ***Currently***, I\'m designing *fast graph algorithms*, studying *limit of graph sequence* and *machine unlearning*.`,
    `I also enjoy [*photography*](https://street.pbb.wtf/) 📷, writing [*random posts*](./posts) 📝, and staying up late (for no reason) 🌌.`
  ],
  avatar: 'avatar.png',
  professions: [
    'I speak TeX'
