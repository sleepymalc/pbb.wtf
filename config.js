module.exports = {
  ...
  introduction: [
    ...
    `***Now***, I'm: designing *fast graph algorithms*, exploring *machine unlearning*, and studying *graphings*. Occasionally, I\'ll do [photography](https://street.pbb.wtf/) 📷 and write [blog posts](./posts) 📝 besides doing research.`
  ],
  avatar: 'avatar.png',
  professions: [
    'Mathematician'
