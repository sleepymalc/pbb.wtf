module.exports = {
  ...
  introduction: [
    ...
    'I obtained my B.S. degree in **Computer Science** (minor in **Mathematics**) at *University of Michigan (UMich)* 🇺🇸 and B.E. **Electrical Computer Engineering** at *Shanghai Jiao Tong University (SJTU)* 🇨🇳 (dual-degree program).',
