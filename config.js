module.exports = {
  ...
  introduction: [
    'I\'m a first year Ph.D. student at [*UIUC*](https://illinois.edu/) 🌽 advised by [Jiaqi Ma](https://www.jiaqima.com/), holding a [dual Bachelor degree](https://www.ji.sjtu.edu.cn/academics/ipo/study-abroad/degree-programs/) from [*UMich*](https://umich.edu/) 〽️ and [*SJTU*](https://en.sjtu.edu.cn/) 🇨🇳.',
