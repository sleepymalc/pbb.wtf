module.exports = {
  ...
  introduction: [
    ...
    `I do *AI* and *TCS* with **math** on **graphs**. In general, I try to *theoretically* understand algorithms with their provable guarantee on, e.g., *robustness*, *fairness*. I'm currently designing *unlearning approximation algorithms* and characterizing *topologies of graph limits*.`,
    `I think about many problems, while some of them haunt me more than others, e.g., *What is the analogy of **computational complexity theory** for modern (deep) learning problems?*, i.e., how much can we say about the *hardness* of deep learning problems?`,
