module.exports = {
  ...
  introduction: [
    ...
    `In my spare time, I\'ll do [*photography*](https://street.pbb.wtf/) 📷 and write [*blog posts*](./posts) 📝; otherwise, I\'ll do *AI theory* and *TCS* on *graphs* with *math*. Specifically, I enjoy thinking about *graph neural networks* 🤖, various *algorithms* with their *computational complexity* 🧠, and *high dimensional statistic* 📊.`,
